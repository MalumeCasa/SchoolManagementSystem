  ...
  return (
    <div className="min-h-screen bg-[#FDFCF8] selection:bg-orange-200 pb-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-20">
        ...
        <div className="bg-white rounded-[3rem] p-8 md:p-12 shadow-xl shadow-slate-200/50 mb-20 flex flex-col md:flex-row gap-10 items-center border border-slate-100">
        ...
        <div className="bg-slate-900 rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <button className="bg-white hover:bg-orange-50 text-slate-900 px-8 py-4 rounded-full font-bold text-lg transition-all flex items-center gap-3 mx-auto">
...
export default CompleteTeamPage;