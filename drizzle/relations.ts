...
import { assignments, assignmentSubmissions, students, teachers, chatRooms, chatRoomMembers, classes, events, staff, studentFees, feePayments, exams, subjects, notices, studentAttendance, feeStructure, grades, chatMessages, classPeriods, feeDiscounts, curriculum, examResults, subjectClasses, teacherClasses, curriculumProgress, reportCards, reportCardSubjects, academicYears, academicTerms, curriculumChapters, curriculumTopics, studentCurriculumProgress, users, notifications, userSessions, attendanceSummary } from "./schema";
